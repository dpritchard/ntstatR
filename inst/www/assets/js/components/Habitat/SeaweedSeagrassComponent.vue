...
export default {
    ...
    data() {
        return {
            answer: this.value,
            basename: "seaweed-seagrass",
            question: "How much seaweed or sea grass is at the site?",
            options: {
                NS: {val: -1, label: "-", level: "secondary", msg: "Not Sure."},
                0: {val: 0, label: "0", level: "danger", msg: "None"},
                1: {val: 1, label: "1", level: "danger", msg: "A few small patches."},
                2: {val: 2, label: "2", level: "danger", msg: "Some large or small patches."},
                3: {val: 3, label: "3", level: "warning", msg: "Lots of large patches."},
                4: {val: 4, label: "4", level: "success", msg: "Blanketed. It's everywhere."}
            }
        }
    },
