...
export default {
    ...
    data() {
        return {
            answer: this.value,
            basename: "algal-bloom",
            question: "Is there a thick layer of bright green 'sea lettuce' (Ulva), or a brown or green slimy thread-like alga covering much of the site?",
            options: {
